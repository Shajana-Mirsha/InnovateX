      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredHackathons.map((hack) => (
            <div
              key={hack._id}
              className="bg-white rounded-2xl border border-slate-200 hover:border-blue-300 hover:shadow-md transition flex flex-col h-full overflow-hidden justify-between group shadow-sm"
            >
              <div className="p-6 flex-grow flex flex-col space-y-4">
                <div className="flex items-center justify-between gap-2">
                  <span className="px-2.5 py-0.5 text-2xs font-semibold rounded-full bg-slate-100 text-slate-700 uppercase">
                    {hack.mode}
                  </span>
                ...
                <div>
                  <h3 className="text-base font-bold text-slate-900 group-hover:text-blue-600 transition tracking-tight">
                    {hack.title}
                  </h3>
                ...
                <div className="space-y-2 border-t border-slate-100 pt-4 mt-auto text-xs text-slate-500">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Domain: <strong className="text-slate-800">{hack.domain}</strong></span>
                  </div>
                  <div className="flex items-center gap-2">
