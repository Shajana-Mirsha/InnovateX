      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm flex flex-col md:flex-row gap-6 justify-between items-start">
        ...
        {user && user.role === "participant" && (
          <div className="shrink-0 w-full md:w-auto">
            {isLeader ? (
              <div className="p-3.5 bg-amber-50 border border-amber-200 rounded-xl text-xs text-amber-800 max-w-xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                return (
                  <div key={member._id || member} className="py-4 first:pt-0 last:pb-0 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-full bg-blue-50 border border-blue-200 text-blue-700 flex items-center justify-center font-bold text-xs">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-slate-900 flex items-center gap-2">
                          ...
                          {memberIsLeader && (
                            <span className="text-2xs font-semibold bg-amber-50 text-amber-700 px-2 py-0.5 rounded-full border border-amber-200">
                              Leader
                            </span>
                          )}
                        </p>
        ...
        <div>
          <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
            ...
            <div>
              <p className="text-2xs text-slate-400 uppercase font-semibold">Hackathon</p>
              <Link
                to={`/hackathons/${team.hackathon?._id || team.hackathon}`}
                className="text-sm font-bold text-blue-600 hover:text-blue-800 mt-1 block transition"
              >
